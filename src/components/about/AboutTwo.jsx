          ...
          >
            <div className="td_section_heading td_style_1 td_mb_40">
              ...
              <h2 className="td_section_title td_fs_48 td_mb_24">
                Excellence in Entrance Exam Coaching Since 15+ Years
              </h2>
              <p className="td_section_subtitle td_fs_18 mb-0">
                Trinetra Academy is dedicated to providing top-quality coaching for NEET, JEE, and EAMCET aspirants. With experienced faculty including ISRO scientists and IIT graduates, we ensure every student receives personalized attention and comprehensive preparation for their entrance exams.
              </p>
            </div>
