            ...
            <div className="row">
              <div className="col-sm-6">
                ...
                >
                  ...
                  <div className="td_card_info">
                    <h2 className="td_card_title mb-0 td_fs_18 td_semibold td_white_color">
                      <Link to="/contact">Campus Student Life</Link>
                    </h2>
                ...
                >
                  ...
                  <div className="td_card_info">
                    <h2 className="td_card_title mb-0 td_fs_18 td_semibold td_white_color">
                      <Link to="/contact">Recreations & Wellness</Link>
                    </h2>
                    <Link to="/contact" className="td_card_btn">
                      <svg
                        width="23"
              ...
              <div className="col-sm-6">
                ...
                >
                  ...
                  <div className="td_card_info">
                    <h2 className="td_card_title mb-0 td_fs_18 td_semibold td_white_color">
                      <Link to="/contact">Arts & Cultural Program</Link>
                    </h2>
                    <Link to="/contact" className="td_card_btn">
                      <svg
                        width="23"
                ...
                >
                  ...
                  <div className="td_card_info">
                    <h2 className="td_card_title mb-0 td_fs_18 td_semibold td_white_color">
                      <Link to="/contact">Sports & Fitness</Link>
                    </h2>
                    <Link to="/contact" className="td_card_btn">
                      <svg
                        width="23"
