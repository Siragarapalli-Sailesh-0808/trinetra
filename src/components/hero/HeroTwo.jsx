      ...
      <div className="container">
        ...
        >
          <h1 className="td_hero_title td_fs_64 td_mb_30">
            ...
            Coaching for NEET, JEE, EAMCET
          </h1>
          <p className="td_hero_subtitle td_fs_18 td_heading_color td_mb_40">
            Best Rank Guidance for NEET / JEE / EAPCET Entrance Exams. 
            Expert faculty, limited batches, and personal attention for every student.
          </p>
